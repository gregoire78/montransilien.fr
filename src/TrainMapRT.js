                    ...
                    <Marker position={new LatLng(this.state.trainPosition.gps.lat, this.state.trainPosition.gps.long)} icon={new Icon({
                        ...
                        ${btoa(`<svg xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 92.82 144.01" width="34" height="52.75">
                                    ...
                                    <g transform="matrix(0.26458333,0,0,0.26458333,48.148201,72.521831)" style="stroke:#000000;stroke-width:3;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1">
                                        <path d="m 182.9,551.7 c 0,0.1 0.2,0.3 0.2,0.3 0,0 175.2,-269 175.2,-357.4 C 358.3,64.5 269.5,7.9 182.9,7.7 96.3,7.9 7.5,64.5 7.5,194.6 7.5,283 182.8,552 182.8,552 Z" style="fill:#${this.state.trainRoute.line.color};stroke:#000000;stroke-width:3;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"/>
                                    </g>
